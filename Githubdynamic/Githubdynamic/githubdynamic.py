...
list.insert(0,listdata)
listdata = ["Connor Fritz",0]
list.insert(1,listdata)
listdata = ["Eric Cen",0]
list.insert(2,listdata)
listdata = ["Hao Yao",0]
list.insert(3,listdata)
listdata = ["Fei He",0]
list.insert(4,listdata)
listdata = ["Chengjing Li",0]
list.insert(5,listdata)
listdata = ["Xiyu Wang",0]
list.insert(6,listdata)
listissue=list.copy()
for dict in data:
    name=dict["author"]["login"]
    if name=="ErickMachado95":
        list[0]=["Erick Machado", dict["total"]];
    elif name == "cdfritz7":
        list[1] = ["Connor Fritz", dict["total"]];
    elif name == "ec505":
        list[2] = ["Eric Cen", dict["total"]];
    elif name == "haoyao0131":
        list[3] = ["Hao Yao", dict["total"]];
    elif name == "feiut":
        list[4] = ["Fei He", dict["total"]];
    elif name == "FredyLi":
        list[5] = ["Chengjing Li", dict["total"]];
    elif name == "dldbb":
        list[6] = ["Xiyu Wang", dict["total"]];
print(list)
